...
determineTime(Date, Truck, LW, Time):- getLoadTruck(Date, LW, LL,_), addTareTruck(Truck,LL, LLT),
                                           cidadeArmazem(Id), append([Id|LW],[Id],Routes),
...
NearestWarehouse(_,[],1000000,_):-!.
NearestWarehouse(Departure,[W1|Warehouses],LessTime,Warehouse):-NearestWarehouse(Departure,Warehouses,LessTime1,Warehouse1),
                                                                dadosCam_t_e_ta(_,Departure,W1,Time,_,_),
...
bfsNearestWarehouse(Departure,[W|RemainingWarehouses],[NextWarehouse|Route]):-NearestWarehouse(Departure,[W|RemainingWarehouses],_,NextWarehouse),
                                                                              delete([W|RemainingWarehouses],NextWarehouse,MissingWarehouses),
                                                                              bfsNearestWarehouse(NextWarehouse,MissingWarehouses,Route).
...
bestRouteNearestWarehouse(Date,Truck,Route,Time):-RouteWarehouses(VisitWarehouse,Date),
                                                             cidadeArmazem(Departure),
                                                             bfsNearestWarehouse(Departure,VisitWarehouse,Route),
...
deliveryPlusMass([W1|Warehouses],Date,GreaterMass,Warehouse):-deliveryPlusMass(Warehouses,Date,GreaterMass1,Warehouse1),
                                                           entrega(_,Date,Mass,W1,_,_),
...
bfsWarehousePlusMass(Date,[W|RemainingWarehouses],[NextWarehouse|Route]):-deliveryPlusMass([W|RemainingWarehouses],Date,_,NextWarehouse),
                                                                              delete([W|RemainingWarehouses],NextWarehouse,MissingWarehouses),
                                                                              bfsWarehousePlusMass(Date, MissingWarehouses,Route).
...
bestRoutePlusMass(Date,Truck,Route,Time):-RouteWarehouses(VisitWarehouse,Date),
                                                             bfsWarehousePlusMass(Date,VisitWarehouse,Route),
                                                             determineTime(Date,Truck,Route,Time), !.
...
/*##### HEURISTICA 3- COMBINAR TEMPO COM W MASSA 
...
bestRelationDelivery(_,[],_, -10000000,_):-!.
bestRelationDelivery(Departure,[W1|Warehouses],Date,BestRelation,Warehouse):-bestRelationDelivery(Departure,Warehouses,Date,BestRelation1,Warehouse1),
                                                           dadosCam_t_e_ta(_,Departure,W1,Time,_,_),
                                                           entrega(_,Date,Mass,W1,_,_),
...
bfsBestRelation(_,_,[],[]):-!.
bfsBestRelation(Date,Departure,[W|RemainingWarehouses],[NextWarehouse|Route]):-bestRelationDelivery(Departure,[W|RemainingWarehouses],Date,_,NextWarehouse),
                                                                              delete([W|RemainingWarehouses],NextWarehouse,MissingWarehouses),
                                                                              bfsBestRelation(Date,NextWarehouse,MissingWarehouses,Route).
...
bestRouteBestRelation(Date,Truck,Route,Time):-RouteWarehouses(VisitWarehouse,Date),
                                                        cidadeArmazem(Departure),
                                                        bfsBestRelation(Date,Departure,VisitWarehouse,Route),
                                                        determineTime(Date,Truck,Route,Time), !.